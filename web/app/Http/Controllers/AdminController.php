...
class AdminController extends Controller
{
    ...
    public function index()
    {
        ...
        $immunizationCount = ImmunizationRecord::count();
        ...
        $intendedMethods = FamilyPlanning::whereNotNull('intended_fp_method')
            ->select('intended_fp_method')
            ->distinct()
            ->pluck('intended_fp_method')
            ->toArray();
    ...
    {
        $activities = User::whereNotNull('last_login_at')
            ->orderBy('last_login_at', 'desc')
            ->paginate(15);
    ...
    public function familyPlanningRecords()
    {
        ...
        return view('admin.family-planning-records', compact('records'));
    }
    ...
    public function familyPlanningEditHistory($id)
    {
        ...
        $editHistory = FamilyPlanningEdit::where('family_planning_id', $id)
            ->with('user')
            ->orderBy('created_at', 'desc')
            ->get();
            
        return view('admin.edit-history', compact('record', 'editHistory'));
    }
