        ...
        <div class="card-body">
            <form action="{{ route('family-planning.update', $familyPlanning->id) }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('birthdate') is-invalid @enderror" id="birthdate" name="birthdate" value="{{ old('birthdate', $familyPlanning->birthdate?->format('Y-m-d')) }}" required>
                    @error('birthdate')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_served') is-invalid @enderror" id="date_served" name="date_served" value="{{ old('date_served', $familyPlanning->date_served?->format('Y-m-d')) }}" required>
                    @error('date_served')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_counselled_pregnant') is-invalid @enderror" id="date_counselled_pregnant" name="date_counselled_pregnant" value="{{ old('date_counselled_pregnant', $familyPlanning->date_counselled_pregnant?->format('Y-m-d')) }}">
                ...
                <div class="mb-3">
                    ...
                    <input type="date" class="form-control @error('date_encoded') is-invalid @enderror" id="date_encoded" name="date_encoded" value="{{ old('date_encoded', $familyPlanning->date_encoded?->format('Y-m-d')) }}" required>
                    @error('date_encoded')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
