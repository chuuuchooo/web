...
<head>
    ...
    <script src="{{ asset('build/assets/charts-2f808de0.js') }}" defer></script>
        ...
        <div class="sidebar-menu">
            <ul class="nav flex-column">
                @if(auth()->user()->isAdmin)
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::is('admin/user-activity') ? 'active' : '' }}" href="{{ route('admin.user-activity') }}">
                            <i class="bi bi-clock-history me-2"></i> <span>User Activity Log</span>
                        </a>
                    </li>
                    <li class="nav-item">
